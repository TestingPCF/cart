...
////        Mockito.doThrow(RuntimeException.class).when(cartRepository).save(cart);
...
//    }
   ...
   // @Test
    ...
    public final void testAddItemInCartSuccess() throws Exception {
        ...
        Mockito.doNothing().when(rabbitTemplate).convertAndSend(RabbitmqCartConfig.EXCHANGE_NAME_CART,
