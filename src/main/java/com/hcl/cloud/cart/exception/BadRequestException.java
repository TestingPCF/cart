...
/**
 * @author kumar_sanjay
 * checked Exception which needs to be checked when
 * request is invalid.
 */
public class BadRequestException extends Exception {
 ...
 /**
  * Constructs a {@link BadRequestException} with
  * <code>null</code> as its detailed message.
  */
  ...
  */
 public BadRequestException(final String messageParam) {
  super(messageParam);
  this.message = messageParam;
 }

 /**
  * Constructs a {@link BadRequestException} with the specified
  * detailed message and its cause;
